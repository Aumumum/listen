...
export declare type IReactivePropsConfig = {
  [key in AdapterPropName]?: IReactivePropConfig;
};
export declare type IReactivePropsStore = {
...
export declare type ItemsPredicate<T = unknown> = (item: ItemAdapter<T>) => boolean;
export declare type ItemsUpdater<T = unknown> = (item: ItemAdapter<T>, update: () => void) => void;
export declare type ItemsProcessor<T = unknown> = (items: ItemAdapter<T>[]) => void;
export declare type BufferUpdater<T = unknown> = (item: ItemAdapter<T>) => unknown;
...
declare type MethodResult = Promise<AdapterMethodResult>;
