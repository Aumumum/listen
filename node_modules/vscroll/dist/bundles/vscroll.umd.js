 ...
 * Version: 1.2.0 (2021-07-14T23:49:15.395Z)
 * Author: Denis Hilt
 * License: MIT
 */
...
(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('vscroll', ['exports'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.VScroll = {}));
    ...
    ***************************************************************************** */
    ...
    exports.AdapterPropName = void 0;
    ...
    })(exports.AdapterPropName || (exports.AdapterPropName = {}));
    var AdapterPropType;
    ...
    var Name = exports.AdapterPropName;
    ...
    var AdapterContext = /** @class */ (function () {
      function AdapterContext(config) {
        ...
        Object.defineProperty(this, exports.AdapterPropName.augmented, __assign({ get: function () { return false; } }, conf));
        Object.defineProperty(this, exports.AdapterPropName.version, __assign({ get: function () { return core.version; } }, conf));
    ...
    var Scroll = /** @class */ (function (_super) {
      ...
      Scroll.getScrollEvent = function (position, previous) {
        ...
        var direction = exports.Direction.forward;
        if (previous) {
    ...
    var Update = /** @class */ (function (_super) {
      ...
      Update.doUpdate = function (scroller, params) {
        ...
        var _a = viewport.getEdgeVisibleItem(buffer.items, exports.Direction.backward), firstItem = _a.item, firstIndex = _a.index, firstItemDiff = _a.diff;
    ...
    var PreClip = /** @class */ (function (_super) {
      ...
      PreClip.prepareClip = function (scroller) {
        ...
        if (PreClip.isForward(scroller, lastIndex)) {
          PreClip.prepareClipByDirection(scroller, exports.Direction.forward, lastIndex);
        }
        if (!clip.doClip) {
      ...
      PreClip.isBackward = function (scroller, firstIndex) {
        ...
        if (fetch.direction !== exports.Direction.backward) {
      ...
      PreClip.isForward = function (scroller, lastIndex) {
        ...
        if (fetch.direction !== exports.Direction.forward) {
    ...
    var Viewport = /** @class */ (function () {
      ...
      Viewport.prototype.getEdgeVisibleItem = function (items, direction) {
        ...
        var opposite = bwd ? exports.Direction.forward : exports.Direction.backward;
    ...
    var DefaultSize = /** @class */ (function () {
      ...
      DefaultSize.prototype.get = function () {
        switch (this.sizeStrategy) {
          case exports.SizeStrategy.Average:
            return this.averageSize;
          case exports.SizeStrategy.Frequent:
      ...
      DefaultSize.prototype.recalculate = function (cacheSize) {
        if (this.sizeStrategy === exports.SizeStrategy.Constant) {
          return false;
        }
        var _a = this.recalculation, oldItems = _a.oldItems, newItems = _a.newItems, removed = _a.removed;
        ...
        if (this.sizeStrategy === exports.SizeStrategy.Average) {
    ...
    var Adapter = /** @class */ (function () {
      ...
      Adapter.prototype.initialize = function (buffer, state, logger, adapterRun$) {
        ...
        Object.defineProperty(this.demand, exports.AdapterPropName.bufferInfo, {
          get: function () { return ({
    ...
    exports.INVALID_DATASOURCE_PREFIX = INVALID_DATASOURCE_PREFIX;
    exports.Workflow = Workflow;
    exports.getDefaultAdapterProps = getDefaultAdapterProps;
    exports.makeDatasource = makeDatasource;
    exports.packageInfo = core;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=vscroll.umd.js.map
